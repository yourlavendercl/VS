...
mutate(wrongre="死亡日期早于出生日期")           
table(Totaldeath_a4$qdis)
...
qc2_08<-Totaldeath12 %>%
    ...
    mutate(wrongre="填报日期早于死亡日期")#Deathreg 里ccd码是109分类的，不对；应以104为准
...
qc3_11<-Totaldeath12 %>% 
 ...
 #-----合并所有符合条件的数据框-----------------
    ...
    names(merge.data) [1:146]<-cols
     write.xlsx(merge.data,"/Volumes/CL 工作硬盘/SCDC信息所/各区工作一览表/2020死亡报卡一览表/每月上交数据/12月/所有审核有问题的数据.xlsx")
     ...
     outall %>% filter(outall$qdis2=="101") %>% write.xlsx("/Volumes/CL 工作硬盘/scdc信息所/各区工作一览表/数据审核质控/黄浦1.xlsx")
     outall %>% filter(outall$qdis2=="104") %>% write.xlsx("/Volumes/CL 工作硬盘/scdc信息所/各区工作一览表/数据审核质控/徐汇1.xlsx")
     outall %>% filter(outall$qdis2=="105") %>% write.xlsx("/Volumes/CL 工作硬盘/scdc信息所/各区工作一览表/数据审核质控/长宁1.xlsx")
     outall %>% filter(outall$qdis2=="106") %>% write.xlsx("/Volumes/CL 工作硬盘/scdc信息所/各区工作一览表/数据审核质控/静安1.xlsx")
     outall %>% filter(outall$qdis2=="107") %>% write.xlsx("/Volumes/CL 工作硬盘/scdc信息所/各区工作一览表/数据审核质控/普陀1.xlsx")
     outall %>% filter(outall$qdis2=="109") %>% write.xlsx("/Volumes/CL 工作硬盘/scdc信息所/各区工作一览表/数据审核质控/虹口1.xlsx")
     outall %>% filter(outall$qdis2=="110") %>% write.xlsx("/Volumes/CL 工作硬盘/scdc信息所/各区工作一览表/数据审核质控/杨浦1.xlsx")
     outall %>% filter(outall$qdis2=="112") %>% write.xlsx("/Volumes/CL 工作硬盘/scdc信息所/各区工作一览表/数据审核质控/闵行1.xlsx")
     outall %>% filter(outall$qdis2=="113") %>% write.xlsx("/Volumes/CL 工作硬盘/scdc信息所/各区工作一览表/数据审核质控/宝山1.xlsx")
     outall %>% filter(outall$qdis2=="114") %>% write.xlsx("/Volumes/CL 工作硬盘/scdc信息所/各区工作一览表/数据审核质控/嘉定1.xlsx")
     outall %>% filter(outall$qdis2=="115") %>% write.xlsx("/Volumes/CL 工作硬盘/scdc信息所/各区工作一览表/数据审核质控/浦东1.xlsx")
     outall %>% filter(outall$qdis2=="116") %>% write.xlsx("/Volumes/CL 工作硬盘/scdc信息所/各区工作一览表/数据审核质控/金山1.xlsx")
     outall %>% filter(outall$qdis2=="117") %>% write.xlsx("/Volumes/CL 工作硬盘/scdc信息所/各区工作一览表/数据审核质控/松江1.xlsx")
     outall %>% filter(outall$qdis2=="118") %>% write.xlsx("/Volumes/CL 工作硬盘/scdc信息所/各区工作一览表/数据审核质控/青浦1.xlsx")
     outall %>% filter(outall$qdis2=="120") %>% write.xlsx("/Volumes/CL 工作硬盘/scdc信息所/各区工作一览表/数据审核质控/奉贤1.xlsx")
     outall %>% filter(outall$qdis2=="151") %>% write.xlsx("/Volumes/CL 工作硬盘/scdc信息所/各区工作一览表/数据审核质控/崇明1.xlsx")
     
     #--------------------------------字段内容名称不一致----------------------------------
     
     
     table(Totaldeath12$qdis,Totaldeath12$x120,useNA = 'ifany')
     table(Totaldeath12$qdis,Totaldeath12$x22,useNA = 'ifany')
     table(Totaldeath12$qdis,Totaldeath12$x23,useNA = 'ifany')
     table(Totaldeath12$qdis,Totaldeath12$x24,useNA = 'ifany')
     table(Totaldeath12$qdis,Totaldeath12$x25,useNA = 'ifany')
     table(Totaldeath12$qdis,Totaldeath12$x30,useNA = 'ifany')
     table(Totaldeath12$qdis,Totaldeath12$x125,useNA = 'ifany')
     table(Totaldeath12$qdis,Totaldeath12$x129,useNA = 'ifany')
     table(Totaldeath12$qdis,Totaldeath12$x122,useNA = 'ifany')
     table(Totaldeath12$qdis,Totaldeath12$x4,useNA = 'ifany')
     table(Totaldeath12$qdis,Totaldeath12$x13,useNA = 'ifany')
     table(Totaldeath12$qdis,Totaldeath12$x121,useNA = 'ifany')
     table(Totaldeath12$qdis,Totaldeath12$x120,useNA = 'ifany')
     table(Totaldeath12$qdis,Totaldeath12$x14,useNA = 'ifany')
     table(Totaldeath12$qdis,Totaldeath12$x1,useNA = 'ifany')
